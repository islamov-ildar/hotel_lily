...
<template>
<!--  <div v-if="showDiscount" class="fixed bottom-[275px] left-[40px] z-[11]">--> TODO lg-version
...
<!--              &lt;!&ndash;              <div class="flex items-center font-montserratSemiBold text-[27px]">&ndash;&gt;-->
<!--              &lt;!&ndash;                  Цены июня на начало июля!&ndash;&gt;-->
<!--              &lt;!&ndash;              </div>&ndash;&gt;-->
<!--              <div class="flex items-center font-montserratSemiBold text-[27px]">-->
<!--                {{ data.main }}-->
<!--              </div>-->
<!--              &lt;!&ndash;              <div class="flex font-montserratRegular items-center text-[23px]">&ndash;&gt;-->
<!--              &lt;!&ndash;                  *Низкие цены до 15 июля&ndash;&gt;-->
<!--              &lt;!&ndash;              </div>&ndash;&gt;-->
...
<!--    </div>-->
<!--  </div>-->
  <div v-if="showDiscount" class="fixed bottom-[275px] left-[40px] z-[11] max-w-[65%]">
    ...
    <div class="relative flex items-center">
      <transition name="fullBtn">
        <div v-if="showFullBtn"
             class="z-[11] cursor-pointer absolute rounded-[60px] left-[40px] top-0 px-[35px] py-[17px] text-[28px] bg-yellowMain text-[#FFFFFF]">
          {{ label }}
        </div>
      </transition>
      <transition name="smallBtn">
        <div v-if="!showFullBtn" class="z-[10] absolute mt-[-4px] left-[40px] top-0 w-[86px] h-[86px] yellowBgTelegram">
