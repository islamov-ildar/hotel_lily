  ...
  <div class="font-montserratRegular text-whiteMain flex flex-col items-center">
    ...
    <div class="w-[1008px] flex ">
      <div class="max-w-[1008px] mt-[35px]">
        ...
        <div>
          *Завтраки предоставляются с июня по сентябрь, включены в стоимость проживания
        </div>
        <div class="mt-[35px]">
          Комнат в номере: 1
        </div>
        ...
        <div>
          Мебель: двуспальная кровать, кресло-кровать, стол, стулья, шкаф, вешалка, зеркало.
        </div>
        <div>
          Удобства: сплит-система, холодильник, спутниковое ТВ, телевизор, Wi-Fi интернет, эл. чайник, посуда, фен, терраса.
        </div>
      </div>
    </div>
