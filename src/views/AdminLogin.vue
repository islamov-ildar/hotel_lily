          ...
          <div class="border-2 border-blueMain text-blueMain font-montserratMedium text-[18px] bg-whiteMain p-[50px]">
            <div class="border border-blueMain">
              ...
              <div class="flex justify-center items-center">
                <div class="flex flex-col justify-between items-center h-full gap-[15px] mb-[30px] font-montserratSemiBold">
                  ...
                  <div class="w-full flex justify-end mt-[19px]">
                    <div class="relative">
                      <div class="absolute top-[-30px] left-[5px] text-mainPink text-[18px] font-montserratMedium text-center w-full">Неверный логин или пароль</div>
                      <button class="text-whiteMain text-[20px] font-montserratSemiBold bg-yellowMain px-[123px] py-[20px]">Войти</button>
                    </div>
                  </div>
                </div>
              </div>
